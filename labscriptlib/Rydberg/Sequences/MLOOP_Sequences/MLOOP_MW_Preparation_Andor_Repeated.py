...
if __name__ == '__main__':
    ...
    # Add optical pumping:
    t+=100e-6
    utils.jump_from_previous_value(op_aom_power, t, 1.0)#OP_OPTIMIZATION_POWER)#0.5)#0.8)#0.6)
    ...
    for i in np.arange(N_repeat):
        ...
        utils.jump_from_previous_value(sacher_aom_power, t, 0.45)# PROBE_RATE)#0.45)#0.45)#0.7)#0.6)#0.4)#0.5)#0.6)#0.8)# 0.6)#0.2)#1.2)# 0.4)#1)#1.2)#0.6)#0.4) # 0.07 #0.6
