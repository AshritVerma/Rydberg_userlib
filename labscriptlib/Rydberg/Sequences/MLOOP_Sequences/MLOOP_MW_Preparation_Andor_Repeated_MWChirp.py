...
if __name__ == '__main__':
    ...
    agilentE8257D.set_freq_amp(MW_PREP_FREQ, 4)#MW_RF_POW)#-2) # set MW freq in GHz, pow in dBm
    ##################################
    ...
    ## MW PULSE SHAPING:
    t_total = preparation_duration
    amplitude = 0.8 # in V
    offset = 0.0 # in V
    carr_freq = 19.0*10**6 # 19.0*10**6
    sweep_freq = 2.0*10**6/t_total #2.0*10**6/t_total
