...
if __name__ == '__main__':
    ...
    agilent_sg1.set_freq_amp(PROBE_FREQ*10**6/16,10) # assuming preparation frequency is in MHz
    ...
    first_pulse_fraction = 0.5 #0.5# 0.75 #1.5 #0.75# for 25mV on PD: 3.0 #1.2 #2.0
    ...
    # Add optical pumping:
    t+=100e-6
    utils.jump_from_previous_value(op_aom_power, t, 2.0 )#0.5)#0.8)#0.6)
    ...
    for i in np.arange(N_repeat):
        ...
        utils.jump_from_previous_value(probe_aom_power, t, 0.75)#0.45)#0.45)#0.7)#0.6)#0.4)#0.5)#0.6)#0.8)# 0.6)#0.2)#1.2)# 0.4)#1)#1.2)#0.6)#0.4) # 0.07 #0.6
