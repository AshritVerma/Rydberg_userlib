...
if __name__ == '__main__':
    ...
    # utils.ramp_from_previous_value(dt808_aom_power, t, 10e-3, 2.9, samplerate=COIL_SAMPLE_RATE)
    ...
    final_difference_freq = 0.8e6
    n_steps = 40

    freq_step = (AOD_DIFFERENCE_FREQ - final_difference_freq)/(2*n_steps)
    ...
    for i in range(n_steps):
        ...
        sidetrap_770_ad9959.jump_frequency(t, "AOD0", AOD_CENTER_FREQ + AOD_DIFFERENCE_FREQ/2 - (i+1) * freq_step)

        t += step_time/2
        ramp_time += step_time/2
        sidetrap_770_ad9959.jump_frequency(t, "AOD1", AOD_CENTER_FREQ - AOD_DIFFERENCE_FREQ/2 + (i+1) * freq_step)
