...
class KoheronCTL200Worker(Worker):
    ...
    def init(self):
        ...
        print(f"Initializing KoheronCTL200 worker with COM port: {self.com_port}")
        ...
        try:
            ...
            """
            self.connection.stop_bits = StopBits.one
            self.connection.parity = Parity.none
            self.connection.flow_control = 0
            """
